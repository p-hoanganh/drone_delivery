...
{   
    ...
    std::string contact1_topic = "/gazebo/default/physics/contacts";
    
    

    impl_->contact1_sub_ = impl_->gznode_->Subscribe(contact1_topic, &DronePluginPrivate::OnContact1Update, impl_.get());
    // impl_->contact2_sub_ = impl_->gznode_->Subscribe(contact2_topic, &DronePluginPrivate::OnContact2Update, impl_.get());
    // impl_->contact3_sub_ = impl_->gznode_->Subscribe(contact3_topic, &DronePluginPrivate::OnContact3Update, impl_.get());
    // impl_->contact4_sub_ = impl_->gznode_->Subscribe(contact4_topic, &DronePluginPrivate::OnContact4Update, impl_.get());
...
void DronePluginPrivate::OnContact1Update(ConstContactsPtr &contacts) {
  int min_contacts = 2;
...
void DronePluginPrivate::updateThrust() {
  ...
  // std::cout << "Torque: " << resulant_torque << std::endl;
  lock.unlock();
  }
